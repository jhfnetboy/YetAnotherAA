...
A NestJS-based microservice for BLS12-381 signature generation and on-chain node
registration for the AAStarValidator system.
...
- Production deployments should use secure key management and environment
  variables
...
The demo tool provides a complete end-to-end example of using the BLS signer
service for ERC-4337 account abstraction transfers.
