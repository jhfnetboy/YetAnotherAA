    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex items-center justify-center space-x-4">
          <div className={`flex items-center ${step === 'email' ? 'text-blue-600' : step === 'verification' ? 'text-blue-600' : 'text-green-600'}`}>
          ...
          <div className={`w-8 h-0.5 ${step === 'verification' || step === 'passkey' ? 'bg-blue-600' : 'bg-gray-300'}`}></div>
          <div className={`flex items-center ${step === 'verification' ? 'text-blue-600' : step === 'passkey' ? 'text-green-600' : 'text-gray-400'}`}>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
              step === 'verification' ? 'bg-blue-600 text-white' : 
              step === 'passkey' ? 'bg-green-600 text-white' : 
