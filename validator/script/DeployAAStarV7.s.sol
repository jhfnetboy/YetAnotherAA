...
/**
 * @title DeployAAStarV7
 * @dev Complete deployment script for AAStarV7 system including BLS key registration
 *
 * Usage:
 * 1. Deploy system only:
 *    forge script script/DeployAAStarV7.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 2. Deploy system and register BLS keys:
 *    REGISTER_KEYS=true forge script script/DeployAAStarV7.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 3. Deploy with existing validator:
 *    EXISTING_VALIDATOR=0x... forge script script/DeployAAStarV7.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 4. Full deployment with existing validator and key registration:
 *    EXISTING_VALIDATOR=0x... REGISTER_KEYS=true forge script script/DeployAAStarV7.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 */

import "forge-std/Script.sol";
import "../src/AAStarValidator.sol";
import "../src/AAStarAccountV7.sol";
import "../src/AAStarAccountFactoryV7.sol";

contract DeployAAStarV7System is Script {
    // EntryPoint v0.7 addresses for different networks
    // Sepolia EntryPoint v0.7
    address constant SEPOLIA_ENTRY_POINT_V7 = 0x0000000071727De22E5E9d8BAf0edAc6f37da032;
    // Mainnet EntryPoint v0.7
    ...
    function run() external {
        ...
        console.log("==== Deploying Complete AAStarV7 System ====");
        ...
        AAStarAccountV7 accountImpl = new AAStarAccountV7(IEntryPoint(entryPointAddress));
        console.log("Account Implementation V7:", address(accountImpl));

        // 3. Deploy Factory
        AAStarAccountFactoryV7 factory = new AAStarAccountFactoryV7(IEntryPoint(entryPointAddress));
        ...
        console.log("");
        console.log("==== Deployment Summary (V7) ====");
        console.log("VALIDATOR_CONTRACT_ADDRESS=", address(validator));
        console.log("AASTAR_ACCOUNT_FACTORY_V7_ADDRESS=", address(factory));
        console.log("AASTAR_ACCOUNT_V7_IMPLEMENTATION_ADDRESS=", address(accountImpl));
        ...
        console.log("This is EntryPoint v0.7 deployment");
