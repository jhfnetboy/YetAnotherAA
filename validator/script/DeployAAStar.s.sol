...
/**
 * @title DeployAAStar
 * @dev Complete deployment script for AAStarV6 system including BLS key registration
 *
 * Usage:
 * 1. Deploy system only:
 *    forge script script/DeployAAStar.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 2. Deploy system and register BLS keys:
 *    REGISTER_KEYS=true forge script script/DeployAAStar.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 3. Deploy with existing validator:
 *    EXISTING_VALIDATOR=0x... forge script script/DeployAAStar.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 *
 * 4. Full deployment with existing validator and key registration:
 *    EXISTING_VALIDATOR=0x... REGISTER_KEYS=true forge script script/DeployAAStar.s.sol --rpc-url <RPC_URL> --private-key <PRIVATE_KEY> --broadcast
 */
...
contract DeployAAStarSystem is Script {
    ...
    function run() external {
        ...
        console.log("==== Deploying Complete AAStarV6 System ====");
        ...
        AAStarAccountV6 accountImpl = new AAStarAccountV6(IEntryPoint(ENTRY_POINT));
        ...
        console.log("AASTAR_ACCOUNT_FACTORY_ADDRESS=", address(factory));
        console.log("AASTAR_ACCOUNT_IMPLEMENTATION_ADDRESS=", address(accountImpl));
        console.log("ENTRY_POINT_ADDRESS=", ENTRY_POINT);
